...
function showWelcome() {
    ...
    let dist = getDistance(121.506398, 31.245384, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //���ﻻ���Լ��ľ�γ��
    ...
    document.getElementById("welcome-info").innerHTML =
        `&nbsp; &nbsp; &nbsp; &nbsp; ��ӭ����<span>${pos}</span>��С��飬${timeChange}<br>&nbsp; &nbsp; &nbsp; &nbsp; 
������<span>վ��</span>Լ��<span>${dist}</span>�������IPΪ��${ip},${posdesc}`;
